...
R.fernfawn = {
  ...
  draw(g) {
    ...
    g.line(18, 37, 18, 44, 'b', 2);             // legs
    g.line(25, 38, 25, 45, 'b', 2);
    g.line(32, 38, 32, 45, 'd', 2);
    g.line(37, 37, 37, 44, 'd', 2);
...
R.thornbuck = {
  ...
  draw(g) {
    ...
    g.line(19, 38, 19, 46, 'b', 2);
    g.line(26, 39, 26, 47, 'b', 2);
    g.line(33, 39, 33, 47, 'd', 2);
    g.line(38, 38, 38, 46, 'd', 2);
...
R.sylvastag = {
  ...
  draw(g) {
    ...
    g.line(20, 38, 20, 47, 'b', 3);
    g.line(28, 40, 28, 47, 'b', 2);
    g.line(35, 40, 35, 47, 'd', 2);
    g.line(41, 38, 41, 47, 'd', 3);
...
R.sparkit = {
  ...
  draw(g) {
    ...
    g.line(17, 38, 17, 43, 'y', 2);
    g.line(28, 38, 28, 43, 'y', 2);
  }
};
...
R.voltail = {
  ...
  draw(g) {
    ...
    g.line(18, 38, 18, 45, 'y', 2);
    g.line(25, 40, 25, 46, 'y', 2);
    g.line(33, 39, 33, 45, 'd', 2);
    // sharp ears
...
R.wyrmble = {
  ...
  draw(g) {
    ...
    g.line(17, 40, 17, 44, 'p', 2);
    g.line(30, 40, 30, 44, 'p', 2);
  }
};
...
R.cindermite = {
  ...
  draw(g) {
    ...
    // legs
    g.line(16, 34, 13, 39, 'd', 1);
    g.line(22, 36, 20, 41, 'd', 1);
    g.line(29, 36, 30, 41, 'd', 1);
    g.line(34, 33, 37, 38, 'd', 1);
    g.outline('o');
    g.eye(11, 19, 3, 4);
    g.eye(17, 19, 3, 4);
  }
...
R.pyroach = {
  ...
  draw(g) {
    ...
    // six legs
    g.line(16, 32, 11, 38, 'd', 2);
    g.line(23, 35, 20, 42, 'd', 2);
    g.line(31, 35, 33, 42, 'd', 2);
    g.line(37, 31, 42, 37, 'd', 2);
    g.outline('o');
...
R.trotling = {
  ...
  draw(g) {
    ...
    // legs
    g.line(19, 37, 19, 45, 'b', 2);
    g.line(25, 38, 25, 46, 'b', 2);
    g.line(32, 38, 32, 46, 'd', 2);
    g.line(37, 37, 37, 45, 'd', 2);
    // neck + head
...
R.gallopyre = {
  ...
  draw(g) {
    ...
    // legs mid-stride
    g.line(18, 37, 16, 46, 'b', 3);
    g.line(25, 39, 25, 47, 'b', 3);
    g.line(33, 39, 34, 47, 'd', 3);
    g.line(39, 36, 42, 45, 'd', 3);
    // neck + noble head
...
R.zappling = {
  ...
  draw(g) {
    ...
    g.eye(9, 13, 3, 4);
    g.eye(15, 13, 3, 4);
    g.line(14, 32, 10, 37, 't', 1);
    g.line(20, 34, 18, 39, 't', 1);
  }
};
...
R.scorpide = {
  ...
  draw(g) {
    ...
    // legs
    g.line(16, 36, 11, 41, 't', 1);
    g.line(23, 38, 21, 43, 't', 1);
    g.line(30, 37, 33, 42, 't', 1);
    g.outline('o');
    g.seam(['p'], ['b', 'd'], 'o');
    g.eye(17, 15, 3, 4);
    g.eye(23, 15, 3, 4);
...
R.hexkit = {
  ...
  draw(g) {
    ...
    g.line(16, 38, 16, 43, 'b', 2);
    g.line(28, 38, 28, 43, 'b', 2);
  }
};
...
R.mossquito = {
  ...
  draw(g) {
    ...
    // legs
    g.line(18, 28, 12, 34, 's', 1);
    g.line(30, 28, 36, 34, 's', 1);
    g.line(19, 33, 14, 40, 's', 1);
    g.line(29, 33, 34, 40, 's', 1);
    g.outline('o');
    g.eye(20, 11, 3, 4);
    g.eye(26, 11, 3, 4);
  }
